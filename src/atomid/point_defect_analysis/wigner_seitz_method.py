...
def analyze_defects(
    reference_positions: Sequence[Tuple[Real, Real, Real]],
    actual_positions: Sequence[Tuple[Real, Real, Real]],
    species_ref: Optional[Sequence[str]] = None,
    species_actual: Optional[Sequence[str]] = None,
